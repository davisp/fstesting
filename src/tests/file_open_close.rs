...
pub mod linux_open_ne {
    crate::open_ne! {
        ...
        open_ne_57: (libc::O_RDWR, libc::O_ASYNC, true, 0),
        open_ne_58: (libc::O_RDWR, libc::O_DIRECT, true, 0),
        open_ne_59: (libc::O_RDWR, libc::O_DSYNC, true, 0),
        open_ne_60: (libc::O_RDWR, libc::O_LARGEFILE, true, 0),
        open_ne_61: (libc::O_RDWR, libc::O_NOATIME, true, 0),
        open_ne_62: (libc::O_RDWR, libc::O_NOCTTY, true, 0),
        open_ne_63: (libc::O_RDWR, libc::O_NDELAY, true, 0),
        open_ne_64: (libc::O_RDWR, libc::O_PATH, true, 0),
        open_ne_65: (libc::O_RDWR, libc::O_SYNC, true, 0),
        open_ne_66: (libc::O_RDWR, libc::O_TMPFILE, true, 0),
    }
}
...
pub mod linux_open_creat {
    super::open_creat! {
        ...
        open_creat_64: (libc::O_RDWR, libc::O_PATH, true, 0),
        open_creat_65: (libc::O_RDWR, libc::O_SYNC, true, 0),
        open_creat_66: (libc::O_RDWR, libc::O_TMPFILE, true, 0),
    }
}
...
pub mod linux_open_exist_ro {
    super::open_exist_ro! {
        ...
        open_exist_ro_57: (libc::O_RDWR, libc::O_ASYNC, true, 0),
        open_exist_ro_58: (libc::O_RDWR, libc::O_DIRECT, true, 0),
        open_exist_ro_59: (libc::O_RDWR, libc::O_DSYNC, true, 0),
        open_exist_ro_60: (libc::O_RDWR, libc::O_LARGEFILE, true, 0),
        open_exist_ro_61: (libc::O_RDWR, libc::O_NOATIME, true, 0),
        open_exist_ro_62: (libc::O_RDWR, libc::O_NOCTTY, true, 0),
        open_exist_ro_63: (libc::O_RDWR, libc::O_NDELAY, true, 0),
        open_exist_ro_64: (libc::O_RDWR, libc::O_PATH, true, 0),
        open_exist_ro_65: (libc::O_RDWR, libc::O_SYNC, true, 0),
        open_exist_ro_66: (libc::O_RDWR, libc::O_TMPFILE, true, 0),
    }
}
...
pub mod linux_open_exist_rw {
    crate::open_exist_rw! {
        ...
        open_exist_rw_66: (libc::O_RDWR, libc::O_TMPFILE, true, 0),
    }
}
